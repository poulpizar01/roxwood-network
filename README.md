...
- **Absences** : bouton "Définir les rôles approbateurs" (même sélection multiple que Tickets), bouton "Définir/Retirer le salon de suivi", et gestion des webhooks sortants dédiés (voir section Absences plus bas).
